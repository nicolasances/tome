...
ARG TOME_SOURCES_API_ENDPOINT
ARG TOME_LANGUAGE_API_ENDPOINT
ARG GCP_PID
...
ENV NEXT_PUBLIC_TOME_SOURCES_API_ENDPOINT=${TOME_SOURCES_API_ENDPOINT}
ENV NEXT_PUBLIC_TOME_LANGUAGE_API_ENDPOINT=${TOME_LANGUAGE_API_ENDPOINT}
...
ENV NEXT_PUBLIC_GCP_PID=${GCP_PID}
