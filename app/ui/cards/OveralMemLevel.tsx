...
export default function OverallMemLevel() {
    ...
    const calculateOverallMemLevel = (memLevels: TopicMemLevel[] | undefined) => {

        if (memLevels == null || memLevels.length == 0) return 0;
        ...
        return sum / memLevels.length
    }

    const perc = calculateOverallMemLevel(tomeContext.topicMemLevels?.memLevels);
    ...
    return (
        <div className="flex flex-row bg-transparent rounded-md items-center justify-center h-24 min-w-24 space-x-1">
            ...
            <div className="">
                <div className="text-2xl">{perc.toFixed(0)}%</div>
