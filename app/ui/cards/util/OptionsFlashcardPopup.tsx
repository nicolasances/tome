...
export function DateFlashcardPopup({ open, question, correctYear, sectionTitle, id, cardNumber, totalCards, onClose, onAnswerSelected }: { open: boolean, question: string, correctYear: number, sectionTitle: string, id: string, cardNumber: number, totalCards: number, onClose: () => void, onAnswerSelected: (isCorrect: boolean) => void }) {
