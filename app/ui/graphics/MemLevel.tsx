...
export default function MemLevel({ perc }: Readonly<{ perc: number }>) {
    ...
    return (
        <div className="flex flex-row bg-transparent rounded-md items-center justify-center h-10 min-w-10 space-x-1">
            <div className="relative w-8 h-8 flex items-center justify-center">
                ...
                <div className="absolute text-base font-400 text-cyan-950 flex justify-center items-center">
                    <svg className={`fill-cyan-100`} style={{opacity: `${perc + 20}%`}} width="50%" height="50%" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
