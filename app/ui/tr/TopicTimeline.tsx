...
export default function TopicTimeline() {
    ...
    const height = 'calc(100vh - var(--app-header-height) - var(--app-footer-height) - 100px - 64px)'
    ...
    return (
        <div className="flex flex-col items-center relative" style={{ maxHeight: '100%', height: '100%', paddingBottom: '24px' }}>
            <div className="flex flex-row justify-center h-full absolute w-full">
                <div className="w-1/3"></div>
                <div className="w-8 min-w-8 h-full flex justify-center">
                    <div className="h-full w-1 border-4 border-cyan-200 rounded"></div>
                </div>
