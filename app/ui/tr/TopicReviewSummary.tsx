        ...
        <div className="flex flex-1 flex-col w-full">
            {
                ...
                <div className="relative mt-4">
                    ...
                    <div className="text-base overflow-scroll no-scrollbar -mx-2 px-2 mt-1" style={{ maxHeight: 'calc(100vh - var(--app-header-height) - var(--app-footer-height) - 100px - 64px)', paddingBottom: '48px' }}>
